...
export default function ProfileGroup({ members }: Props) {
  ...
  return (
    <div className='w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 grid grid-cols-6 gap-4'>
