...
export default function PastEvents({ pastEvents }: Props) {
  ...
  return (
    <div className='max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700'>
      <p className='text-md text-center font-semibold pb-3'>Past events</p>
      <ul className='max-w-md divide-y divide-gray-200 dark:divide-gray-700 max-h-[200px] overflow-y-auto'>
        {pastEvents &&
          pastEvents.map((i, j) => (
            <li
